...
function Logo({ showText = true, size = 'md' }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <svg width={px} height={px} viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
        <defs>
      ...
      {showText && (
        <span className="text-xl font-serif tracking-wide text-slate-900 dark:text-white transition-colors duration-200">
          Evently<span></span>
        </span>
      )}
    </div>
